...
class SiliconFlowEmbeddings(BaseEmbeddings):

    """OpenAI embeddings implementation using their API."""

    AVAILABLE_MODELS = {
        "BAAI/bge-m3": 8192,  # Latest model, best performance/cost ratio
        "netease-youdao/bce-embedding-base_v1": 512,  # Latest model, highest performance
        "BAAI/bge-large-zh-v1.5": 512,  # Legacy model
    }
    ...
    def __init__(
        ...
        # Setup OpenAI client
        self.client = OpenAI(
            api_key=api_key or os.getenv("SILICON_API_KEY"),
